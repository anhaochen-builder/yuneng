...
const routes = [
  ...
  { path: '/workorders', name: 'WorkOrderManagement', component: () => import('@/views/WorkOrderManagement.vue'), meta: { title: '智能工单' } },
  { path: '/benchmark', name: 'BenchmarkDashboard', component: () => import('@/views/BenchmarkDashboard.vue'), meta: { title: '诊断评测' } },
  { path: '/rlhf', name: 'RLHFDashboard', component: () => import('@/views/RLHFDashboard.vue'), meta: { title: 'RLHF优化' } },
  { path: '/automation', name: 'AutomationManagement', component: () => import('@/views/AutomationManagement.vue'), meta: { title: '自动化集成' } },
  { path: '/shift', name: 'ShiftReport', component: () => import('@/views/ShiftReport.vue'), meta: { title: '交接班' } },
